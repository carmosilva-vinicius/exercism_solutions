...
public class TelemetryClient
{
    ...
    {
        var telemetryData = car.GetTelemetryData(ref serialNum,
            out var batteryPercentage, out var distanceDrivenInMeters);
        ...
        return $"usage-per-meter={batteryUsagePerMeter.ToString()}";
    }
}
